        ...
        <div>
            <div className="home-container home">
                <div className="general">
                    ...
                    <p className="text">By educators, for educators. We are the oldest and most trusted web publishing platform for teachers and students.Use our easy invite codes and class management tools to get started. And most importantly, it’s free! Our content filters, moderation options, and multiple privacy tools keep everyone safe.</p>
                </div>
